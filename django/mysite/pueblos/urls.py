...
#    url(r'^api/busqueda/(?P<n_pueblo>[\w\-\_]*)/$',views.busq,name='busq'),
    ...
    url(r'^api/(?P<id_u>\d+]*)/noticias/(?P<pagina>\d+]*)/$', views.todosnot1, name='todosnot1'), #Funciona
    url(r'^api/noticias/(?P<init>\d+]*)/(?P<fin>\d+]*)/(?P<iduser>\d+]*)/$', views.todasnoticias, name='todasnoticias'), #Funciona
    url(r'^api/noticias/(?P<pagina>\d+]*)/(?P<iduser>\d+]*)/$', views.todasnoticias1, name='todasnoticias1'), #Funciona
  ...
  # url(r'^api/comentarios/ultimo/$',views.lastcomment, name='lascomment'),
    url(r'^api/busqueda/(?P<datos>[\,\:\(\ \w\-\_\d\)]*)/(?P<int1>\d+]*)/(?P<int2>\d+]*)/(?P<id_user>\d+]*)/$',views.busqueda, name='busqueda'), #Funciona
    url(r'^api/busqueda/(?P<datos>[\,\:\(\ \w\-\_\d\)]*)/(?P<pagina>\d+]*)/(?P<id_user>\d+]*)/$',views.busqueda1, name='busqueda1'), #Funciona
