...
urlpatterns = patterns('',
    ...
    url(r'^api/noticias/(?P<id_n>\d+]*)/(?P<categoria>.*)/(?P<id_u>\d+]*)/$', views.nuevacategoria, name='nuevacategoria'),
    url(r'^api/noticias/(?P<id_n>\d+]*)/categorias/$', views.catfromnot, name='catfromnot'),
    url(r'^api/(?P<id_u>\d+]*)/noticias/$', views.todosnot, name='todosnot'),
    ...
    url(r'^api/usuario/seguimiento/(?P<id_u>\d+)/$',views.siguiendo, name='siguiendo'),
    ...
    url(r'^api/votacion/(?P<id_n>\d+)/(?P<id_u>\d+)/(?P<id_c>\d+)/$',views.votaciones, name='votaciones'),
    url(r'^api/categoriza/(?P<id_n>\d+)/(?P<id_cnew>\d+)/(?P<id_u>\d+)/$',views.categorizar, name='categorizar'),
    url(r'^api/denunciar/(?P<id_u>\d+)/(?P<id_c>\d+)/$',views.denuncia, name='denuncia'),
