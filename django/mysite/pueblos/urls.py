...
#    url(r'^api/busqueda/(?P<n_pueblo>[\w\-\_]*)/$',views.busq,name='busq'),
    ...
    url(r'^api/noticias/(?P<init>\d+]*)/(?P<fin>\d+]*)/$', views.todasnoticias, name='todasnoticias'), #Funciona
  ...
  # url(r'^api/comentarios/ultimo/$',views.lastcomment, name='lascomment'),
    url(r'^api/busqueda/(?P<datos>[\,s\:\(\w\-\_\d\)]*)/(?P<int1>\d+]*)/(?P<int2>\d+]*)/$',views.busqueda, name='busqueda'), #Funciona
